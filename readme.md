...
![Histogram showing showing the median total visible injuries from car crashes in 2022-2023 by Home Owners Loan Corporation grades (so A, B, C, and D). A and B graded areas had half as many median injuries as C and D graded areas]('https://raw.githubusercontent.com/bucketteOfIvy/traffic-talk/main/figures/injuries_per_redlined_areas.png')
